...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <a href="./login.jsp" class="btn btn-default navbar-btn">学生登录</a>
    </div><!-- /.container-fluid -->
</nav>
<div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
          <div class="jumbotron">
              ...
              <p><a class="btn btn-primary btn-lg" href="#" role="button">SIMS</a></p>
          </div>
      </div>
      ...
      <div class="col-md-4">
          ...
          <div class="panel panel-default">
              ...
              <s:if test="flag=='passworderror'">
                   <div class="alert alert-danger" role="alert">密码和用户名不匹配</div>
              </s:if>
              ...
              <div class="panel-footer">
                  ...
                  <form action="superlogin.action" method="post">
                      <div class="form-group">
                        ...
                        <input type="name" class="form-control" id="name" name="adminname" placeholder="Enter name">
                      </div>
                      <div class="form-group">
